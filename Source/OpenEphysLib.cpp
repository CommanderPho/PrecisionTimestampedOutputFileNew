...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "PhoPrecisionTimestampNew"; // <---- update
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->processor.name = "PhoStartTimestampNew"; //Processor name shown in the GUI

		//Type of processor. Can be FILTER, SOURCE, SINK or UTILITY. Specifies where on the processor list will appear
		info->processor.type = Processor::Type::SINK; // I changed this
