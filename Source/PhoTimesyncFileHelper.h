...
bool writeOutCustomFile(std::chrono::system_clock::time_point recordingStartSavedTimestamp, bool is_dry_run, bool enable_debug_printing) {
	...
	//bool curr_recording_thread_status = CoreServices::RecordNode::getRecordThreadStatus(); // pre 2024-03-27
	...
	if (enable_debug_printing) {
		...
		CoreServices::sendStatusMessage("\t \t curr_recording_thread_status: " + String(int(curr_recording_thread_status))); // "juce::String::String(bool)" removed?
	}
